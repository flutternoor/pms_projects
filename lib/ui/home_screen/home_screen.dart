    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(children: [
          ...
          ///Category Row
          const RowWidget(tileName: "Category",seeAllText: 'See All',),
          ...
          ///Notice Board Row
          const RowWidget(tileName: 'Notice Board', seeAllText: 'See All'),
          const SizedBox(height: 10,),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 25,),
                   Text('Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since 1500s.'
                      ...
                      Expanded(
                        child: Row(
                          children: [
                            ...
                            Text('27-Jan-2023',style: TextStyle(fontSize: 12),),
                          ],
                        ),
                      ),
                      Expanded(
          ...
          const SizedBox(height: 10,),
          ///My Subjects Row
          const RowWidget(tileName: "My Subjects",seeAllText: 'See All',),
          const SizedBox(height: 10,),
          Container(
            height: 100,
          ...
          SizedBox(
              height:100,
              width: 100,
              child: Image.asset('assets/images/islamyat_img.png')),
